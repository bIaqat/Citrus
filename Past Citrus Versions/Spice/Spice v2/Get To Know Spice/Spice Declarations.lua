...
rgb, hsv, hex, cstr, cinv = Color.fromRGB, Color.fromHSV, Color.fromHex,Color.fromString, Color.toInverse
...
newImage, getImage, getImageSet, newImages = Imagery.Images.new, Imagery.Images.get, Imagery.Images.getImage, Imagery.Images.newFromSheet
createImage, playImages, stopImages = Imagery.newInstance, Imagery.playGif, Imagery.stopGif
setImage = Imagery.setImage	
setDefault, getDefault, toDefault = Properties.Default.set, Properties.Default.get, Properties.Default.toDefaultProperties
newCustomProperty = Properties.Custom.new
API = Properties.RobloxAPI
newProperty, has, get, set, vset = Properties.newProperty, Properties.hasProperty, Properties.getProperties, Properties.setProperties, Properties.setVanillaProperties
getChildrenOfProperty, getDescendantsOfProperty = Properties.getChildrenOfProperty, Properties.getDescendantsOfProperty
